...
const minOffset = () => {
  ...
  const getData = async () => {
    try {
      const response = await axios.get("http://localhost:3004/user?" + filter + "=" + value + "&_limit=" + limit + "&_page=" + offset);
        ...
        <div className="App">
          <Layout>
            <Content>
              ...
              <Col span={4}>
                <div className="Card">
                <Input type="number" placeholder="limit" onChange={(e) => {handleLimit(e)}} />
              ...
              <Row gutter={8} style={{marginLeft: '40px'}}>
                ...
                <h1>POST Request to JSON Server</h1>
                  ...
                  >
                    ...
                    <Input type="text" placeholder="email" allowClear />
